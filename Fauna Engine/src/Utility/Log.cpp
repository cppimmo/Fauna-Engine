...
void Fauna::Log::Message_Box(std::string what)
{
	Log::Get().PrepareMessageBox();
	MessageBoxA(nullptr, what.c_str(), "ERROR", MB_ICONERROR);
}

void Fauna::Log::Message_Box(std::string what, std::string title)
{
	Log::Get().PrepareMessageBox();
	MessageBoxA(nullptr, what.c_str(), title.c_str(), MB_OK);
}

void Fauna::Log::Message_Box(HRESULT hr, std::string what)
{
	Log::Get().PrepareMessageBox();
	if (FAILED(hr))
	{
...
void Fauna::Log::Message_Box(const std::exception& e)
{
	Log::Get().PrepareMessageBox();
	MessageBoxA(nullptr, e.what(), "ERROR", MB_ICONERROR);
}

void Fauna::Log::FlushLog()
{
...
Fauna::Log& Fauna::Log::Get()
{
	static Log instance;
	return instance;
}

std::string Fauna::Log::GetSystemTime()
{
...
void Fauna::Log::SetWindowPointer(Window* pWindow)
{
	this->pWindow = pWindow;
}

void Fauna::Log::PrepareMessageBox()
{
	// perform window resizing and disable fullscreen
}

void Fauna::Log::DebugPrint(const std::string& what, Log::LOG_TYPE log_type) {
